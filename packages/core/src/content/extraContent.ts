...
export function getExtraItem(id: string) {
  return EXTRA_ITEMS[id as keyof typeof EXTRA_ITEMS] ?? null;
}

export function getExtraMonster(id: string) {
  return EXTRA_MONSTERS[id as keyof typeof EXTRA_MONSTERS] ?? null;
}

export function getExtraScene(id: string) {
  return EXTRA_SCENES[id as keyof typeof EXTRA_SCENES] ?? null;
}

export function getExtraEvent(id: string) {
  return EXTRA_EVENTS[id as keyof typeof EXTRA_EVENTS] ?? null;
}
...
export function getAllExtraEvents(): RandomEventDef[] {
  return Object.values(EXTRA_EVENTS) as RandomEventDef[];
}