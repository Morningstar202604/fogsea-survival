...
import { createInitialState, applyChoice, resolveScene, runDaily, exportState, importState, Rng, TALENTS, drawTalentChoices, applyTalent, computeRank, rankMessage, RANK_TOTAL, } from './index.js';
describe('开局天赋系统', () => {
    ...
    it('铁胃天赋降低每日食物/水消耗', () => {
        ...
        const parse = (msgs) => Number(msgs.find((m) => m.includes('食物-')).match(/食物-(\d+)/)[1]);
...
//# sourceMappingURL=talents.test.js.map