...
export const PHASE7_SCENES: Record<string, SceneNode> = {
  // 场景1：基地升级典礼
...
export const PHASE7_EVENTS: RandomEventDef[] = [
  // 事件1：变异生物群来袭
  {
 ...
 * 将第七阶段内容合并到主内容包中
 */
export function mergePhase7Content(content: any): any {
