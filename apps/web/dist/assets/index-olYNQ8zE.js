...
【获得教训：逃跑不是长久之计。下次兽潮，你必须防守。】`}]}},yl=[{id:`phase1_strange_sound`,text:`奇怪的声音`,minDay:2,weight:10,maxTriggers:1,choices:[{id:`investigate`,text:`循着声音去看看`,effects:[{kind:`resource`,resource:`sanity`,delta:-8}],result:`你循着声音走了过去。
...
【获得抗性：迷雾低语。下次再遇到类似情况，理智损失减半。】`,next:`__return__`}]}],bl={duoduo_hear_cry:{id:`duoduo_hear_cry`,text:`你在探索废墟的时候，听到了一个声音。
...
【获得重要伏笔：商人老张的特殊商品。等你足够强了，他会给你看一些「不应该存在的东西」。】`}]}},xl=[{id:`phase2_abandoned_clinic`,text:`你发现了一个废弃的医疗站。
...
【伏笔：迷雾中的路标。你没有相信它。但它说的是真的吗？安全区真的存在吗？真相真的在那个方向吗？死亡又是什么？】`,next:`__return__`}]}],Sl={doctor_chen_find:{id:`doctor_chen_find`,text:`你在探索一栋废弃的医院时，听到了一个声音。
...
【重要伏笔：兽潮退了，但它们还会再来。下一次，可能会更多，更凶猛。你们需要更强的防御，更多的人，更好的武器。】`}]}},Cl=[{id:`phase3_abandoned_armory`,text:`你在探索的时候，发现了一个废弃的军火库。
...
【团体稳定度+20】`,next:`__return__`}]}],wl={mechanic_find_garage:{id:`mechanic_find_garage`,text:`你在探索的时候，发现了一个废弃的修车厂。
...
【重要伏笔：灯塔的秘密。那些生物是什么？它们和迷雾有什么关系？迷雾的真相，真的在那里吗？】`}]}},Tl=[{id:`phase4_abandoned_gas_station`,text:`你在路边发现了一个废弃的加油站。
...
【重要伏笔：灯塔的秘密。安全区的人，知道更多关于灯塔的事情。他们会告诉你吗？】`,next:`__return__`}]}],El={settlement_choose_location:{id:`settlement_choose_location`,text:`到达城北后，你们需要找一个地方，建立自己的据点。
...
【林小雨好感度+15】`}]}},Dl=[{id:`phase5_safe_zone_trade`,text:`希望号安全区的人，来到了你们的据点。
...
【重要伏笔：最终决战。攻入灯塔，找到先知，关掉迷雾。你们，能成功吗？先知，有多强？灯塔的地下，有什么？】`,next:`__return__`}]}],Ol={final_assault_begin:{id:`final_assault_begin`,text:`第46天，黎明。
...
【重要伏笔：新世界。变异动物，超能力者。你们，能在这个，全新的世界里，建立一个，更美好的未来吗？】`}]}},kl=[{id:`phase6_evolutionist_remnants`,text:`你们在搜索的时候，遇到了一群人。
...
【游戏，进入，第七阶段：基地（第66-90天）。更多的内容，等待着，你，去，探索。】`,next:`__return__`}]}],Al={phase7_base_upgrade_ceremony:{id:`phase7_base_upgrade_ceremony`,text:`第66天，清晨。
...
【伏笔：资源分配的矛盾。它，以后，还会，爆发吗？】`}]}},jl=[{id:`phase7_mutant_swarm`,text:`一天清晨，瞭望塔上的哨兵，发出了紧急警报。
...
【重要伏笔：觉醒药剂。它，真的能让人直接觉醒超能力吗？它，有什么副作用？你，会用它吗？】`,next:`__return__`}]}],Ml={phase8_population_boom:{id:`phase8_population_boom`,text:`第91天，清晨。
...
【伏笔：自由联盟。他们，会，去哪里？他们，会，成为，你们的朋友，还是，敌人？】`,next:`__return__`}]}},Nl=[{id:`phase8_superpower_evolution`,text:`一天，陈博士，急匆匆地，找到了你。
...
【重要伏笔：超能力进化。小风的进化，被打断了。他，醒了之后，会怎么样？他，还能完成进化吗？他，会恨你吗？】`,next:`__return__`}]}],Pl={phase9_evolutionists_return:{id:`phase9_evolutionists_return`,text:`第121天，凌晨。
...
【重要伏笔：进化者组织残余。他们，还会，回来的。下次，他们，会，带，更多的，人。】`}]}},Fl=[{id:`phase9_prophet_truth`,text:`一天，陈博士，急匆匆地，找到了你。
...
【重要伏笔：向先知宣战。先知，会，怎么，报复？你们，能，打败，他吗？】`,next:`__return__`}]}],Il={phase10_final_battle:{id:`phase10_final_battle`,text:`第151天，黎明。
...
【感谢，你的，游玩！】`}]}},Ll=[{id:`phase10_postwar_reconstruction`,text:`最终决战结束后，你们开始了战后重建工作。
...
【全剧终】`,next:`__return__`}]}],Rl=[{id:`npc_betrayal`,text:`深夜，你被一阵轻微的响动惊醒。
...
大地在颤抖。雾海尽头，一头山岳般的巨兽缓缓走来，它的每一次呼吸都让雾浪翻滚。兽王来了——这是生死存亡的一战。`,choices:[{id:`o_0`,text:`倾尽全力，与兽王决战`,hint:`九死一生`,effects:[{kind:`resource`,resource:`health`,delta:-30},{kind:`resource`,resource:`energy`,delta:-30},{kind:`flag`,flag:`beast_king_slain`,flagValue:!0}],next:`__return__`,result:`你亲手斩下了兽王的獠牙。那一夜，整个雾海安静得像在默哀。`},{id:`o_1`,text:`退入基地核心，凭工事死守（木材×50、石材×30）`,effects:[{kind:`item`,item:`wood`,amount:-50},{kind:`item`,item:`stone`,amount:-30},{kind:`resource`,resource:`sanity`,delta:-8}],next:`__return__`,result:`城墙在兽王的冲撞下呻吟了三天。第四天清晨，它转身离开了。`},{id:`o_2`,text:`携带轻装撤离，放弃基地`,effects:[{kind:`resource`,resource:`energy`,delta:-20},{kind:`resource`,resource:`sanity`,delta:-12},{kind:`flag`,flag:`abandoned_base`,flagValue:!0}],next:`__return__`,result:`你回头看了一眼燃烧的木屋，转身走进雾里。活着，就还有下一次。`}]}],income:[{resource:`warmth`,delta:-1}],startingResources:{food:{current:80,max:100},water:{current:80,max:100},health:{current:100,max:100},sanity:{current:100,max:100},energy:{current:100,max:100},warmth:{current:100,max:100}}};$.storyline.scenes={...$.storyline.scenes,...vl,...bl,...Sl,...wl,...El,...Ol,...Al,...Ml,...Pl,...Il},$.randomEvents||=[],$.randomEvents=[...$.randomEvents,...yl,...xl,...Cl,...Tl,...Dl,...kl,...jl,...Nl,...Fl,...Ll],$.randomEvents=[...$.randomEvents,...Rl];var zl=[{id:`duoduo`,name:`朵朵`,title:`邻家的妹妹`,linePrefix:`duoduo_`,entryScene:`duoduo_s1_meet`,description:`在便利店废墟里遇到的女孩，把你的木屋当成了全世界的安全岛。`},{id:`laok`,name:`老K`,title:`沉默的巡逻者`,linePrefix:`laok_`,entryScene:`laok_s1_pact`,description:`前特种兵，话少枪稳。他守夜的时候，你能睡个整觉。`},{id:`doc`,name:`林医生`,title:`雾中的医者`,linePrefix:`doc_`,entryScene:`doc_s1_housecall`,description:`背着药箱挨家问诊的执拗人。在雾海里，一板抗生素比黄金贵。`},{id:`rat`,name:`鼠王`,title:`下水道的君主`,linePrefix:`rat_`,entryScene:`rat_s1_return`,description:`地下的情报贩子与规则制定者。他认识每一个人，包括不该认识的人。`},{id:`rescue`,name:`救援队`,title:`无线电那头的声音`,linePrefix:`rescue_`,entryScene:`rescue_s1_wreck`,description:`7 号避难所的幸存者们。信号接通的那一刻，雾海不再只有你一个人。`},{id:`crystal`,name:`结晶之声`,title:`矿脉的低语`,linePrefix:`crystal_`,entryScene:`crystal_s1_vein`,description:`紫色结晶里的存在。它自称朋友——雾里的东西都这么说。`}],Bl=[{min:80,name:`生死之交`},{min:55,name:`挚友`},{min:30,name:`信赖`},{min:10,name:`相识`},{min:0,name:`陌生`}];function Vl(e){let t=new Set(e.visitedScenes??[]);return zl.map(n=>{let r=0;for(let e of t)e.startsWith(n.linePrefix)&&(r+=12);let i=!!e.flags[`line_done_${n.entryScene}`];i&&(r+=10),r=Math.min(100,r);let a=Bl.find(e=>r>=e.min)?.name??`陌生`;return{...n,favor:r,levelName:a,lineDone:i}})}var Hl=`qs_saves_v1`,Ul=`qs_meta_v1`;function Wl(){return Array.from({length:3},()=>({state:null,info:null}))}function Gl(){try{let e=localStorage.getItem(Hl);if(!e)return Wl();let t=JSON.parse(e);return!Array.isArray(t)||t.length!==3?Wl():t.map(e=>{if(!e.json)return{state:null,info:e.info??null};try{return{state:hl(e.json),info:e.info??null}}catch{return{state:null,info:null}}})}catch{return Wl()}}function Kl(e){let t=e.map(e=>({json:e.state?ml(e.state):null,info:e.info}));localStorage.setItem(Hl,JSON.stringify(t))}function ql(e,t){let n=Gl(),r=t.outcome?{type:t.outcome.type,title:t.outcome.title}:null;return n[e]={state:t,info:{day:t.day,updatedAt:new Date().toISOString(),outcome:r}},Kl(n),n}function Jl(e){let t=Gl();return t[e]={state:null,info:null},Kl(t),t}function Yl(){try{let e=localStorage.getItem(Ul);if(!e)return{runs:0,unlockedEndings:[],bestDays:0};let t=JSON.parse(e);return{runs:t.runs??0,unlockedEndings:Array.isArray(t.unlockedEndings)?t.unlockedEndings:[],bestDays:t.bestDays??0}}catch{return{runs:0,unlockedEndings:[],bestDays:0}}}function Xl(e){localStorage.setItem(Ul,JSON.stringify(e))}var Zl=null;function Ql(){return Zl||=$l(),Zl}function $l(){let e=Lt({screen:`menu`,state:null,slots:Gl(),activeSlot:0,log:[],toast:``}),t=new qs,n=q(()=>{if(!e.state)return{text:``,choices:[],inEvent:!1,eventText:``};let t=e.state;if(t.pendingEvents.length>0){let e=Pc($,t.pendingEvents[0]);if(e)return{text:e.text,choices:Ic(e.choices,t),inEvent:!0,eventText:e.text}}let n=Mc($,t.currentScene);return{text:n?.text??`（场景缺失：`+t.currentScene+`）`,choices:n?Ic(n.choices,t):[],inEvent:!1,eventText:``}});function r(t,n){if(n===`scene`){for(let n=e.log.length-1;n>=0;n--)if(e.log[n].kind===`scene`){if(e.log[n].text===t)return;break}}e.log.push({text:t,kind:n})}function i(){e.state&&(e.slots=ql(e.activeSlot,e.state))}function a(t){e.toast=t,setTimeout(()=>{e.toast=``},2600)}function o(){if(!e.state)return;let t=Yl();t.runs+=1;let n=e.state.outcome;n&&n.type===`ending`&&(t.unlockedEndings=Array.from(new Set([...t.unlockedEndings,n.id]))),t.bestDays=Math.max(t.bestDays,e.state.day),Xl(t),i()}function s(n,o){let s=jc($,Yl(),o);e.state=s,e.activeSlot=n,e.log=[],t=new qs;let c=Mc($,s.currentScene);c&&r(c.text,`scene`),o&&r(`【天赋觉醒】你携带着与生俱来的天赋踏入迷雾。`,`system`),i(),e.screen=`game`,a(`新的一局开始了，第 1 天`)}function c(n){let i=e.slots[n];if(!i.state)return;e.state=i.state,e.activeSlot=n,e.log=[],t=new qs,e.screen=`game`;let o=Mc($,i.state.currentScene);o&&r(o.text,`scene`),a(`已读取存档`)}function l(n){if(!e.state)return;let a=e.state,s=a.pendingEvents.length>0?Uc($,a,n,t):Hc($,a,n,t);s.resultText&&r(s.resultText,`result`);for(let e of s.systemMessages??[])r(e,`system`);if(a.outcome)o(),r(`【${a.outcome.title}】${a.outcome.desc}`,`system`);else if(a.pendingEvents.length===0){let t=Mc($,a.currentScene);t&&t.text!==e.log[e.log.length-1]?.text&&r(t.text,`scene`)}i()}function u(){if(!e.state)return;let n=e.state;if(n.pendingEvents.length>0){a(`先处理完眼前的事件`);return}let s=Zc($,n,t);for(let e of s.messages)r(e,`daily`);if(s.dead){o(),r(`【${n.outcome?.title??`死亡`}】${n.outcome?.desc??``}`,`system`),i();return}if(r(`—— 第 ${n.day} 天 ——`,`daily`),s.event)r(s.event.text,`scene`);else{let e=Mc($,n.currentScene);e&&r(e.text,`scene`)}i()}function d(){e.screen=`menu`,e.slots=Gl(),e.state=null}function f(){return e.state?gl(e.state):``}function p(t,n){let r=_l(t);return r?(e.slots=ql(n,r),a(`导入成功`),!0):!1}function m(t){e.slots=Jl(t)}function h(){if(!e.state)return;let t=fs(e.state);t.success?(a(t.message),r(t.message,`system`),i()):a(t.message)}function g(t){if(!e.state)return;let n={x:e.state.base.structures.length,y:0},o=ps(e.state,t,n);if(a(o.message),r(o.message,`system`),o.success){let e=us[t];e&&r(`【基地】${e.name}落成。${e.description}。`,`system`),i()}}function _(t){if(!e.state)return;let n=Vl(e.state).find(e=>e.id===t);if(!n)return;let o=xs(e.state,t,n.favor);o?(a(`${n.name}加入了你的木屋`),r(o,`system`),i()):a(n.favor<30?`羁绊还不够深（需要信赖 30）`:`已在队伍中`)}function v(t){if(!e.state)return;let n=Qo(e.state,t);n.success?(a(n.message),r(n.message,`system`),i()):a(n.message)}function y(t){if(!e.state)return;let n=Zo(e.state,t);n.success?(a(n.message),r(n.message,`system`),i()):a(n.message)}function b(t,n){if(!e.state)return;let o=os(e.state,n,t,1);a(o.message),o.success&&(r(o.message,`result`),i())}function x(t){if(!e.state)return;let n=ss(e.state,`wandering_trader`,t,1);a(n.message),n.success&&(r(n.message,`result`),i())}function S(t){e.state&&(e.state.flags[`story_${t}_started`]=!0,a(`开始探索${t}剧情线`),r(`你决定探索${t}的剧情线...`,`system`),i())}function C(n){if(!e.state||!e.state.combat)return;let o=ic(e.state,e.state.combat,n,t);e.state.combat=o.session;for(let e of o.session.log.slice(-3))r(e,`result`);if(o.ended&&o.result){if(o.result.victory){a(`战斗胜利！`),r(`击败了敌人！获得战利品。`,`system`);let t=e.state.combat?e.state.combat.enemyLevel??1:1,n=wc(t,!0),i=Ec(t,e.state.attributes.luck),s=Qc(e.state,n);if($c(e.state,i),e.state.combatKills+=1,e.state.runStats.kills+=1,o.result.loot){for(let[t,n]of Object.entries(o.result.loot))e.state.inventory[t]=(e.state.inventory[t]??0)+n;let t=Object.entries(o.result.loot).map(([e,t])=>`${e}×${t}`).join(`, `);t&&r(`掉落：${t}`,`result`)}r(`获得经验 +${n}，迷雾积分 +${i}`,`system`),s.leveledUp&&(r(`【升级】等级提升到 ${s.newLevel}！获得1属性点+1技能点，生命上限+10`,`system`),a(`升级！Lv.${s.newLevel}`));let c=el(e.state);for(let e of c)r(`【称号解锁】${e}`,`system`)}else a(`战斗失败！`),r(`你在战斗中落败...`,`system`),Qc(e.state,wc(1,!1));delete e.state.combat}i()}return Lt({...$t(e),viewText:q(()=>n.value.text),viewChoices:q(()=>n.value.choices),inEvent:q(()=>n.value.inEvent),eventText:q(()=>n.value.eventText),newGame:s,continueGame:c,choose:l,endDay:u,backToMenu:d,exportSave:f,importSave:p,deleteSlot:m,upgradeBase:h,build:g,recruit:_,upgradeSkill:v,chooseSpecialization:y,buyFromMarket:b,sellToMarket:x,startStory:S,combatAction:C})}var eu={class:`menu`},tu={class:`slots`},nu={class:`slot-head`},ru={class:`slot-name`},iu={key:0,class:`slot-day`},au={key:0,class:`slot-meta`},ou={key:0},su={key:1},cu={key:1,class:`slot-meta empty`},lu={class:`slot-actions`},uu=[`onClick`],du=[`onClick`],fu=[`onClick`],pu=[`onClick`],mu=[`onClick`],hu={class:`dex`},gu={class:`dex-title`},_u={class:`dex-grid`},vu={class:`talent-modal`},yu={class:`talent-cards`},bu=[`onClick`],xu={class:`talent-tier`},Su={class:`talent-name`},Cu={class:`talent-desc`},wu=or({__name:`MainMenu`,setup(e){let t=Ql(),n=Object.values($.storyline.endings),r=Yl().unlockedEndings,i=n.map(e=>({id:e.id,title:r.includes(e.id)?e.title:`？？？`,unlocked:r.includes(e.id),category:e.category})),a=Jt(null),o=Jt([]),s={S:`SSS·传说`,A:`SR·稀有`,B:`R·普通`};function c(e){o.value=Ys({next:Math.random}),a.value=e}function l(e){a.value!==null&&(t.newGame(a.value,e.id),a.value=null)}function u(e){if(!e)return``;let t=new Date(e);return`${t.getMonth()+1}/${t.getDate()} ${String(t.getHours()).padStart(2,`0`)}:${String(t.getMinutes()).padStart(2,`0`)}`}function d(e){return`存档 ${e+1}`}async function f(e){let n=document.createElement(`input`);n.type=`file`,n.accept=`.qssave,.txt,application/json,text/plain`,n.onchange=async()=>{let r=n.files?.[0];if(!r)return;let i=await r.text();t.importSave(i.trim(),e)},n.click()}function p(){let e=t.exportSave();if(!e)return;let n=new Blob([e],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`迷雾降临_存档${t.activeSlot+1}.qssave`,i.click(),URL.revokeObjectURL(r)}return(e,m)=>(V(),H(`div`,eu,[m[5]||=U(`div`,{class:`menu-title`},[U(`h1`,null,`雾海生存`),U(`p`,{class:`sub`},`迷雾降临`),U(`p`,{class:`desc`},`雾起之后，你成了这座小镇最后的活人。活下去，撑到救援来临。`)],-1),U(`div`,tu,[(V(!0),H(z,null,I(P(3),e=>(V(),H(`div`,{key:e,class:D([`slot`,{filled:P(t).slots[e-1].state}])},[U(`div`,nu,[U(`span`,ru,O(d(e-1)),1),P(t).slots[e-1].state?(V(),H(`span`,iu,`第 `+O(P(t).slots[e-1].info?.day??`?`)+` 天`,1)):G(``,!0)]),P(t).slots[e-1].state?(V(),H(`p`,au,[P(t).slots[e-1].info?.outcome?(V(),H(`span`,ou,O(P(t).slots[e-1].info.outcome.title)+`（已结束）`,1)):(V(),H(`span`,su,`进行中`)),m[2]||=U(`span`,{class:`dot`},`·`,-1),U(`span`,null,O(u(P(t).slots[e-1].info?.updatedAt)),1)])):(V(),H(`p`,cu,`空存档`)),U(`div`,lu,[P(t).slots[e-1].state&&!P(t).slots[e-1].info?.outcome?(V(),H(`button`,{key:0,class:`btn primary`,onClick:n=>P(t).continueGame(e-1)},`继续`,8,uu)):P(t).slots[e-1].state?(V(),H(`button`,{key:1,class:`btn primary`,onClick:t=>c(e-1)},`重开`,8,du)):(V(),H(`button`,{key:2,class:`btn primary`,onClick:t=>c(e-1)},`新游戏`,8,fu)),P(t).slots[e-1].state?(V(),H(`button`,{key:3,class:`btn ghost`,onClick:p},`导出`)):G(``,!0),P(t).slots[e-1].state?(V(),H(`button`,{key:4,class:`btn danger`,onClick:n=>P(t).deleteSlot(e-1)},`清空`,8,pu)):G(``,!0),U(`button`,{class:`btn ghost`,onClick:t=>f(e-1)},`导入`,8,mu)])],2))),128))]),m[6]||=U(`p`,{class:`hint`},`存档保存在本机浏览器。导出后可分享给他人继续游玩。`,-1),U(`div`,hu,[U(`h3`,gu,`结局图鉴（`+O(P(r).length)+` / `+O(P(n).length)+`）`,1),U(`div`,_u,[(V(!0),H(z,null,I(P(i),e=>(V(),H(`span`,{key:e.id,class:D([`dex-chip`,{unlocked:e.unlocked,good:e.unlocked&&e.category===`good`,true:e.unlocked&&e.category===`true`}])},O(e.title),3))),128))])]),a.value===null?G(``,!0):(V(),H(`div`,{key:0,class:`talent-mask`,onClick:m[1]||=Lo(e=>a.value=null,[`self`])},[U(`div`,vu,[m[3]||=U(`h2`,{class:`talent-title`},`天赋觉醒`,-1),m[4]||=U(`p`,{class:`talent-sub`},`雾海听见了你的名字。三选一，选定后不可更改。`,-1),U(`div`,yu,[(V(!0),H(z,null,I(o.value,e=>(V(),H(`button`,{key:e.id,class:D([`talent-card`,`tier-`+e.tier]),onClick:t=>l(e)},[U(`span`,xu,O(s[e.tier]),1),U(`span`,Su,O(e.name),1),U(`span`,Cu,O(e.description),1)],10,bu))),128))]),U(`button`,{class:`btn ghost reroll`,onClick:m[0]||=e=>c(a.value)},`换一批`)])]))]))}}),Tu=(e,t)=>{let n=e.__vccOpts||e;for(let[e,r]of t)n[e]=r;return n},Eu=Tu(wu,[[`__scopeId`,`data-v-17539d2f`]]),Du={class:`resbar`},Ou={class:`resbar-head`},ku={class:`day`},Au={class:`best`},ju={key:0,class:`progression-info`},Mu={class:`info-row`},Nu={class:`value tier`},Pu={class:`info-row`},Fu={class:`value points`},Iu={class:`info-row`},Lu={class:`value`},Ru={class:`info-row`},zu={class:`value points`},Bu={key:0,class:`info-row`},Vu={class:`value spec`},Hu={class:`res-label`},Uu={class:`val`},Wu={class:`track`},Gu={key:1,class:`attributes-panel`},Ku={class:`attr-grid`},qu={class:`attr-item`},Ju={class:`attr-value`},Yu={class:`attr-item`},Xu={class:`attr-value`},Zu={class:`attr-item`},Qu={class:`attr-value`},$u={class:`attr-item`},ed={class:`attr-value`},td=Tu(or({__name:`ResourceBar`,setup(e){let t=Ql(),n=[`food`,`water`,`energy`,`sanity`,`health`],r=q(()=>{let e=t.state;return e?n.map(t=>({key:t,label:Rs[t],current:e.resources[t].current,max:e.resources[t].max,pct:Math.round(e.resources[t].current/e.resources[t].max*100)})):[]}),i=q(()=>{let e=t.state;return!e||!e.attributes?null:e.attributes}),a=q(()=>{let e=t.state;return!e||!e.progression?null:{worldTier:e.progression.currentWorldTier,nextTierDay:e.day+e.progression.daysToNextTier,skillPoints:e.skills?.totalPoints||0,baseLevel:e.base?.level||0,specialization:e.skills?.specialization||null,rank:Qs(e),rankTotal:162}});function o(e){return e<=20?`critical`:e<=50?`low`:`ok`}function s(e){return[`普通`,`困难`,`噩梦`,`地狱`,`深渊`][e-1]||`T${e}`}function c(e){return[`简陋小屋`,`木屋`,`石屋`,`堡垒`,`山谷基地`][e-1]||`Lv.${e}`}return(e,n)=>(V(),H(`div`,Du,[U(`div`,Ou,[U(`span`,ku,`第 `+O(P(t).state?.day??1)+` 天`,1),U(`span`,{class:D([`ap`,{out:(P(t).state?.ap??3)<=0}])},`行动点 `+O(P(t).state?.ap??3)+`/3`,3),U(`span`,Au,`历史最佳 `+O(P(t).state?.meta.bestDays??0)+` 天`,1)]),a.value?(V(),H(`div`,ju,[U(`div`,Mu,[n[0]||=U(`span`,{class:`label`},`世界等级:`,-1),U(`span`,Nu,O(s(a.value.worldTier)),1)]),U(`div`,Pu,[n[1]||=U(`span`,{class:`label`},`幸存者排名:`,-1),U(`span`,Fu,`#`+O(a.value.rank)+` / `+O(a.value.rankTotal),1)]),U(`div`,Iu,[n[2]||=U(`span`,{class:`label`},`基地等级:`,-1),U(`span`,Lu,O(c(a.value.baseLevel)),1)]),U(`div`,Ru,[n[3]||=U(`span`,{class:`label`},`技能点:`,-1),U(`span`,zu,O(a.value.skillPoints),1)]),a.value.specialization?(V(),H(`div`,Bu,[n[4]||=U(`span`,{class:`label`},`专精:`,-1),U(`span`,Vu,O(a.value.specialization===`technology`?`科技`:a.value.specialization===`cultivation`?`修炼`:`通用`),1)])):G(``,!0)])):G(``,!0),(V(!0),H(z,null,I(r.value,e=>(V(),H(`div`,{key:e.key,class:`res`},[U(`div`,Hu,[U(`span`,null,O(e.label),1),U(`span`,Uu,O(e.current)+`/`+O(e.max),1)]),U(`div`,Wu,[U(`div`,{class:D([`fill`,o(e.pct)]),style:pe({width:e.pct+`%`})},null,6)])]))),128)),i.value?(V(),H(`div`,Gu,[n[9]||=U(`h4`,{class:`attr-title`},`属性`,-1),U(`div`,Ku,[U(`div`,qu,[n[5]||=U(`span`,{class:`attr-label`},`力量`,-1),U(`span`,Ju,O(i.value.strength),1)]),U(`div`,Yu,[n[6]||=U(`span`,{class:`attr-label`},`敏捷`,-1),U(`span`,Xu,O(i.value.agility),1)]),U(`div`,Zu,[n[7]||=U(`span`,{class:`attr-label`},`智力`,-1),U(`span`,Qu,O(i.value.intelligence),1)]),U(`div`,$u,[n[8]||=U(`span`,{class:`attr-label`},`幸运`,-1),U(`span`,ed,O(i.value.luck),1)])])])):G(``,!0)]))}}),[[`__scopeId`,`data-v-a74c533a`]]),nd={class:`scene`},rd={key:0,class:`actions`},id=[`disabled`,`onClick`],ad={class:`ct`},od={key:0,class:`ap-chip`},sd={key:0,class:`ch`},cd={key:1,class:`no-ap`},ld={key:0,class:`none`},ud={key:1,class:`end-panel`},dd={class:`end-desc`},fd={class:`end-stats`},pd={class:`end-actions`},md=Tu(or({__name:`SceneView`,setup(e){let t=Ql(),n=Jt(null),r=q(()=>!!t.state?.outcome);zn(()=>t.log.length,async()=>{await xn(),n.value?.scrollTo({top:n.value.scrollHeight,behavior:`smooth`})});function i(e){return!!e.apCost&&(t.state?.ap??3)<=0}function a(e){i(e)||t.choose(e)}return(e,o)=>(V(),H(`div`,nd,[U(`div`,{ref_key:`logBox`,ref:n,class:`log`},[(V(!0),H(z,null,I(P(t).log,(e,t)=>(V(),H(`p`,{key:t,class:D([`line`,`k-`+e.kind])},O(e.text),3))),128))],512),r.value?(V(),H(`div`,ud,[U(`h2`,null,O(P(t).state?.outcome?.title),1),U(`p`,dd,O(P(t).state?.outcome?.desc),1),U(`div`,fd,[U(`span`,null,`存活 `+O(P(t).state?.day)+` 天`,1),U(`span`,null,`触发事件 `+O(P(t).state?.runStats.eventsTriggered)+` 次`,1),U(`span`,null,`已解锁结局 `+O(P(t).state?.meta.unlockedEndings.length)+` 个`,1)]),U(`div`,pd,[U(`button`,{class:`btn primary`,onClick:o[0]||=e=>P(t).newGame(P(t).activeSlot)},`再来一局`),U(`button`,{class:`btn ghost`,onClick:o[1]||=(...e)=>P(t).backToMenu&&P(t).backToMenu(...e)},`返回主菜单`)])])):(V(),H(`div`,rd,[(V(!0),H(z,null,I(P(t).viewChoices,(e,t)=>(V(),H(`button`,{key:t,class:D([`choice`,{blocked:i(e)}]),disabled:i(e),onClick:t=>a(e)},[U(`span`,ad,[ia(O(e.text),1),e.apCost?(V(),H(`span`,od,`AP -`+O(e.apCost),1)):G(``,!0)]),e.hint?(V(),H(`span`,sd,O(e.hint),1)):G(``,!0),i(e)?(V(),H(`span`,cd,`行动点已用完，结束今天吧`)):G(``,!0)],10,id))),128)),P(t).viewChoices.length===0?(V(),H(`p`,ld,`眼前没有可做的事，等待明天的到来。`)):G(``,!0)]))]))}}),[[`__scopeId`,`data-v-af1afc26`]]),hd={key:0,class:`base-panel`},gd={class:`base-header`},_d={class:`base-level`},vd={class:`value`},yd={class:`base-defense`},bd={class:`value`},xd={key:0,class:`buildings`},Sd={key:0,class:`building-category`},Cd={class:`building-list`},wd={class:`building-name`},Td={class:`building-count`},Ed={key:1,class:`building-category`},Dd={class:`building-list`},Od={class:`building-name`},kd={class:`building-count`},Ad={key:2,class:`building-category`},jd={class:`building-list`},Md={class:`building-name`},Nd={class:`building-count`},Pd={key:1,class:`production-info`},Fd={class:`production-grid`},Id={class:`resource-label`},Ld={class:`resource-amount`},Rd={key:2,class:`cap-row`},zd={key:3,class:`build-section`},Bd={class:`build-list`},Vd={class:`build-head`},Hd={class:`build-name`},Ud={class:`build-cost`},Wd={class:`build-desc`},Gd={class:`build-foot`},Kd={key:0,class:`build-req`},qd={key:1,class:`build-req`},Jd={key:2,class:`build-req`},Yd=[`onClick`],Xd={class:`base-actions`},Zd=Tu(or({__name:`BasePanel`,setup(e){let t=Ql(),n=q(()=>t.state?.base??null),r=q(()=>{let e=n.value;if(!e)return null;let t=[],r=[],i=[],a=new Map;for(let t of e.structures??[])a.set(t.structureId,(a.get(t.structureId)??0)+1);for(let[e,n]of a){let a={id:e,label:us[e]?.name??e,count:n};us[e]?.effects?.some(e=>e.type===`production`)?t.push(a):[`wooden_spike`,`fence`,`ballista_tower`,`wall`,`watchtower`].includes(e)?r.push(a):i.push(a)}let o={};for(let t of e.structures??[])for(let e of us[t.structureId]?.effects??[])e.type===`production`&&e.target&&(o[e.target]=(o[e.target]??0)+e.value);return{production:t,defense:r,utility:i,daily:o}}),i=q(()=>{let e=n.value,r=t.state;if(!e||!r)return[];let i=ls[e.level]?.maxStructures??0;return Object.values(us).map(t=>{let n=e.level>=t.minBaseLevel,a=e.structures.length+t.space<=i,o=Object.entries(t.cost).filter(([e,t])=>(r.inventory?.[e]??0)<t).length===0;return{id:t.id,name:t.name,desc:t.description,costText:Object.entries(t.cost).map(([e,t])=>`${Y[e]?.name??e}×${t}`).join(`、`),levelOk:n,spaceOk:a,affordable:o,buildable:n&&a&&o,minBaseLevel:t.minBaseLevel}})}),a=q(()=>{let e=n.value;if(!e)return null;let t=ls[e.level]?.maxStructures??0;return{used:e.structures.length,cap:t,defense:e.totalDefense}});function o(e){return[`简陋小屋`,`木屋`,`石屋`,`堡垒`,`山谷基地`][e-1]||`Lv.${e}`}function s(){return n.value?[`简陋小屋`,`木屋`,`石屋`,`堡垒`,`山谷基地`][n.value.level+1-1]||`已满级`:``}return(e,c)=>n.value?(V(),H(`div`,hd,[c[8]||=U(`h3`,{class:`panel-title`},`基地建设`,-1),U(`div`,gd,[U(`div`,_d,[c[1]||=U(`span`,{class:`label`},`当前等级:`,-1),U(`span`,vd,O(o(n.value.level)),1)]),U(`div`,yd,[c[2]||=U(`span`,{class:`label`},`防御值:`,-1),U(`span`,bd,O(n.value.totalDefense),1)])]),r.value?(V(),H(`div`,xd,[r.value.production.length>0?(V(),H(`div`,Sd,[c[3]||=U(`h4`,{class:`category-title`},`生产设施`,-1),U(`div`,Cd,[(V(!0),H(z,null,I(r.value.production,e=>(V(),H(`div`,{key:e.id,class:`building-item`},[U(`span`,wd,O(e.label),1),U(`span`,Td,`×`+O(e.count),1)]))),128))])])):G(``,!0),r.value.defense.length>0?(V(),H(`div`,Ed,[c[4]||=U(`h4`,{class:`category-title`},`防御设施`,-1),U(`div`,Dd,[(V(!0),H(z,null,I(r.value.defense,e=>(V(),H(`div`,{key:e.id,class:`building-item`},[U(`span`,Od,O(e.label),1),U(`span`,kd,`×`+O(e.count),1)]))),128))])])):G(``,!0),r.value.utility.length>0?(V(),H(`div`,Ad,[c[5]||=U(`h4`,{class:`category-title`},`功能设施`,-1),U(`div`,jd,[(V(!0),H(z,null,I(r.value.utility,e=>(V(),H(`div`,{key:e.id,class:`building-item`},[U(`span`,Md,O(e.label),1),U(`span`,Nd,`×`+O(e.count),1)]))),128))])])):G(``,!0)])):G(``,!0),r.value&&Object.keys(r.value.daily).length>0?(V(),H(`div`,Pd,[c[6]||=U(`h4`,{class:`section-title`},`每日产出`,-1),U(`div`,Fd,[(V(!0),H(z,null,I(r.value.daily,(e,t)=>(V(),H(`div`,{key:t,class:`production-item`},[U(`span`,Id,O(t),1),U(`span`,Ld,`+`+O(e),1)]))),128))])])):G(``,!0),a.value?(V(),H(`div`,Rd,[U(`span`,null,`设施 `+O(a.value.used)+`/`+O(a.value.cap),1),U(`span`,null,`防御工事 `+O(a.value.defense),1)])):G(``,!0),i.value.length>0?(V(),H(`div`,zd,[c[7]||=U(`h4`,{class:`section-title`},`建造清单`,-1),U(`div`,Bd,[(V(!0),H(z,null,I(i.value,e=>(V(),H(`div`,{key:e.id,class:D([`build-card`,{ok:e.buildable}])},[U(`div`,Vd,[U(`span`,Hd,O(e.name),1),U(`span`,Ud,O(e.costText||`免费`),1)]),U(`p`,Wd,O(e.desc),1),U(`div`,Gd,[e.levelOk?e.spaceOk?e.affordable?(V(),H(`button`,{key:3,class:`build-btn`,onClick:n=>P(t).build?.(e.id)},`建造`,8,Yd)):(V(),H(`span`,Jd,`材料不足`)):(V(),H(`span`,qd,`设施空间不足`)):(V(),H(`span`,Kd,`需要基地 `+O(e.minBaseLevel)+` 级`,1))])],2))),128))])])):G(``,!0),U(`div`,Xd,[U(`button`,{class:`btn upgrade`,onClick:c[0]||=e=>P(t).upgradeBase?.()},` 升级基地 → `+O(s()),1)])])):G(``,!0)}}),[[`__scopeId`,`data-v-08e4a730`]]),Qd={key:0,class:`skill-panel`},$d={class:`skill-header`},ef={class:`points-info`},tf={class:`value`},nf={class:`available-points`},rf={class:`value highlight`},af={key:0,class:`specialization-choice`},of={class:`spec-options`},sf=[`onClick`],cf={key:1,class:`current-spec`},lf={class:`value`},uf={key:2,class:`skill-categories`},df={key:0,class:`skill-category`},ff={class:`skill-list`},pf={class:`skill-header-row`},mf={class:`skill-name`},hf={class:`skill-level`},gf={class:`skill-desc`},_f=[`onClick`],vf={key:1,class:`maxed`},yf={key:1,class:`skill-category`},bf={class:`skill-list`},xf={class:`skill-header-row`},Sf={class:`skill-name`},Cf={class:`skill-level`},wf={class:`skill-desc`},Tf=[`onClick`],Ef={key:1,class:`maxed`},Df={key:2,class:`skill-category`},Of={class:`skill-list`},kf={class:`skill-header-row`},Af={class:`skill-name`},jf={class:`skill-level`},Mf={class:`skill-desc`},Nf=[`onClick`],Pf={key:1,class:`maxed`},Ff=Tu(or({__name:`SkillTreePanel`,setup(e){let t=Ql(),n=q(()=>{let e=t.state;return!e||!e.skills?null:{totalPoints:e.skills.totalPoints,availablePoints:e.skills.points,skills:e.skills.skills,specialization:e.skills.specialization,canChooseSpecialization:e.skills.canChooseSpecialization}}),r={technology:`科技`,cultivation:`修炼`,general:`通用`},i=q(()=>{if(!n.value)return null;let e=[],t=[],r=[];for(let[i,a]of Object.entries(n.value.skills)){let n=a;n.branch===`technology`?e.push({id:i,...n}):n.branch===`cultivation`?t.push({id:i,...n}):r.push({id:i,...n})}return{tech:e,cultivation:t,general:r}});function a(e){if(!n.value)return 0;let t=n.value.skills[e];return t?t.level:0}function o(e){if(!n.value)return 3;let t=n.value.skills[e];return t?t.maxLevel:3}function s(e){if(!n.value)return``;let t=n.value.skills[e];return t?t.description:``}function c(e){return n.value?a(e)<o(e)&&n.value.availablePoints>0:!1}function l(e){t.upgradeSkill?.(e)}function u(e){t.chooseSpecialization?.(e)}return(e,t)=>n.value?(V(),H(`div`,Qd,[t[7]||=U(`h3`,{class:`panel-title`},`技能树`,-1),U(`div`,$d,[U(`div`,ef,[t[0]||=U(`span`,{class:`label`},`总技能点:`,-1),U(`span`,tf,O(n.value.totalPoints),1)]),U(`div`,nf,[t[1]||=U(`span`,{class:`label`},`可用点数:`,-1),U(`span`,rf,O(n.value.availablePoints),1)])]),n.value.canChooseSpecialization&&!n.value.specialization?(V(),H(`div`,af,[t[2]||=U(`h4`,{class:`section-title`},`选择专精方向（不可更改）`,-1),U(`div`,of,[(V(),H(z,null,I([`technology`,`cultivation`,`general`],e=>U(`button`,{key:e,class:`spec-btn`,onClick:t=>u(e)},O(r[e]),9,sf)),64))])])):G(``,!0),n.value.specialization?(V(),H(`div`,cf,[t[3]||=U(`span`,{class:`label`},`当前专精:`,-1),U(`span`,lf,O(r[n.value.specialization]),1)])):G(``,!0),i.value?(V(),H(`div`,uf,[i.value.tech.length>0?(V(),H(`div`,df,[t[4]||=U(`h4`,{class:`category-title`},`🔬 科技系`,-1),U(`div`,ff,[(V(!0),H(z,null,I(i.value.tech,e=>(V(),H(`div`,{key:e.id,class:`skill-item`},[U(`div`,pf,[U(`span`,mf,O(e.name),1),U(`span`,hf,`Lv.`+O(a(e.id))+`/`+O(o(e.id)),1)]),U(`p`,gf,O(s(e.id)),1),c(e.id)?(V(),H(`button`,{key:0,class:`upgrade-btn`,onClick:t=>l(e.id)},` 升级 (-1点) `,8,_f)):a(e.id)>=o(e.id)?(V(),H(`div`,vf,` 已达满级 `)):G(``,!0)]))),128))])])):G(``,!0),i.value.cultivation.length>0?(V(),H(`div`,yf,[t[5]||=U(`h4`,{class:`category-title`},`✨ 修炼系`,-1),U(`div`,bf,[(V(!0),H(z,null,I(i.value.cultivation,e=>(V(),H(`div`,{key:e.id,class:`skill-item`},[U(`div`,xf,[U(`span`,Sf,O(e.name),1),U(`span`,Cf,`Lv.`+O(a(e.id))+`/`+O(o(e.id)),1)]),U(`p`,wf,O(s(e.id)),1),c(e.id)?(V(),H(`button`,{key:0,class:`upgrade-btn`,onClick:t=>l(e.id)},` 升级 (-1点) `,8,Tf)):a(e.id)>=o(e.id)?(V(),H(`div`,Ef,` 已达满级 `)):G(``,!0)]))),128))])])):G(``,!0),i.value.general.length>0?(V(),H(`div`,Df,[t[6]||=U(`h4`,{class:`category-title`},`⚔️ 通用系`,-1),U(`div`,Of,[(V(!0),H(z,null,I(i.value.general,e=>(V(),H(`div`,{key:e.id,class:`skill-item`},[U(`div`,kf,[U(`span`,Af,O(e.name),1),U(`span`,jf,`Lv.`+O(a(e.id))+`/`+O(o(e.id)),1)]),U(`p`,Mf,O(s(e.id)),1),c(e.id)?(V(),H(`button`,{key:0,class:`upgrade-btn`,onClick:t=>l(e.id)},` 升级 (-1点) `,8,Nf)):a(e.id)>=o(e.id)?(V(),H(`div`,Pf,` 已达满级 `)):G(``,!0)]))),128))])])):G(``,!0)])):G(``,!0)])):G(``,!0)}}),[[`__scopeId`,`data-v-a87e25da`]]),If={key:0,class:`combat-screen`},Lf={class:`monster-panel`},Rf={class:`monster-header`},zf={class:`monster-name`},Bf={class:`monster-level`},Vf={class:`hp-bar-container`},Hf={class:`hp-label`},Uf={class:`hp-track`},Wf={key:0,class:`monster-desc`},Gf={class:`player-hp`},Kf={class:`hp-label`},qf={class:`hp-track`},Jf={class:`combat-log`},Yf={class:`log-content`},Xf={class:`turn-indicator`},Zf=Tu(or({__name:`CombatScreen`,setup(e){let t=Ql(),n=q(()=>{let e=t.state;return!e||!e.combat?null:{monster:nc[e.combat.enemyId]??null,playerHp:e.resources.health.current,playerMaxHp:e.resources.health.max,monsterHp:e.combat.enemyHp,monsterMaxHp:e.combat.enemyMaxHp,round:e.combat.round,log:e.combat.log||[]}});function r(e,t){return Math.round(e/t*100)}function i(e){return e<=25?`#c0504d`:e<=50?`#c98a3d`:`#4f9d6f`}function a(){t.combatAction?.(`attack`)}function o(){t.combatAction?.(`defend`)}function s(){t.combatAction?.(`use_item`)}function c(){t.combatAction?.(`flee`)}return(e,t)=>n.value?(V(),H(`div`,If,[t[3]||=U(`h3`,{class:`combat-title`},`战斗进行中`,-1),U(`div`,Lf,[U(`div`,Rf,[U(`span`,zf,O(n.value.monster?.name||`未知怪物`),1),U(`span`,Bf,`Lv.`+O(n.value.monster?.level||1),1)]),U(`div`,Vf,[U(`div`,Hf,[t[0]||=U(`span`,null,`生命值`,-1),U(`span`,null,O(n.value.monsterHp)+`/`+O(n.value.monsterMaxHp),1)]),U(`div`,Uf,[U(`div`,{class:`hp-fill enemy`,style:pe({width:r(n.value.monsterHp,n.value.monsterMaxHp)+`%`,background:i(r(n.value.monsterHp,n.value.monsterMaxHp))})},null,4)])]),n.value.monster?.description?(V(),H(`div`,Wf,O(n.value.monster.description),1)):G(``,!0)]),U(`div`,Gf,[U(`div`,Kf,[t[1]||=U(`span`,null,`你的生命`,-1),U(`span`,null,O(n.value.playerHp)+`/`+O(n.value.playerMaxHp),1)]),U(`div`,qf,[U(`div`,{class:`hp-fill player`,style:pe({width:r(n.value.playerHp,n.value.playerMaxHp)+`%`,background:i(r(n.value.playerHp,n.value.playerMaxHp))})},null,4)])]),U(`div`,Jf,[t[2]||=U(`h4`,{class:`log-title`},`战斗记录`,-1),U(`div`,Yf,[(V(!0),H(z,null,I(n.value.log.slice(-8),(e,t)=>(V(),H(`p`,{key:t,class:`log-entry`},O(e),1))),128))])]),U(`div`,{class:`combat-actions`},[U(`button`,{class:`action-btn attack`,onClick:a},` ⚔️ 攻击 `),U(`button`,{class:`action-btn defend`,onClick:o},` 🛡️ 防御 `),U(`button`,{class:`action-btn skill`,onClick:s},` ✨ 技能 `),U(`button`,{class:`action-btn flee`,onClick:c},` 🏃 逃跑 `)]),U(`div`,Xf,` 第 `+O(n.value.round)+` 回合 `,1)])):G(``,!0)}}),[[`__scopeId`,`data-v-59d667ec`]]),Qf={key:0,class:`market-panel`},$f={class:`gold-info`},ep={class:`value`},tp={key:0,class:`merchants-section`},np={class:`merchant-list`},rp={class:`merchant-header`},ip={class:`merchant-name`},ap={class:`merchant-type`},op={key:0,class:`inventory`},sp={class:`item-grid`},cp={class:`item-name`},lp={key:0,class:`item-qty`},up={class:`item-price`},dp=[`onClick`,`disabled`],fp={key:1,class:`prices-section`},pp={class:`price-list`},mp={class:`item-label`},hp={class:`sell-group`},gp={class:`price-value`},_p=[`onClick`],vp={key:2,class:`prices-section`},yp={class:`price-list`},bp={class:`item-label`},xp={class:`price-value`},Sp={key:3,class:`empty-state`},Cp=Tu(or({__name:`MarketPanel`,setup(e){let t=Ql();function n(e,t,n){let r=e.economy?.marketPrices?.[t];return Math.round((r?.currentPrice??Y[t]?.basePrice??0)*n)}let r=q(()=>{let e=t.state;if(!e||!e.economy)return null;let r=(e.economy.unlockedMerchants??[]).map(e=>ns[e]).filter(e=>!!e).map(t=>({id:t.id,name:t.name,location:t.location,items:Object.entries(t.inventory??{}).filter(([e])=>!!Y[e]).map(([r,i])=>({itemId:r,name:Y[r].name,price:n(e,r,t.sellMultiplier),qty:i}))})),i=Object.entries(e.inventory??{}).filter(([e,t])=>(t??0)>0&&!!Y[e]).map(([t,n])=>({itemId:t,name:Y[t].name,count:n,price:Math.round((e.economy?.marketPrices?.[t]?.currentPrice??Y[t]?.basePrice??0)*.6)}));return{currency:e.economy.currency,merchants:r,prices:e.economy.marketPrices??{},inventory:i}});function i(e,n){t.buyFromMarket?.(e,n)}function a(e){t.sellToMarket?.(e)}return(e,t)=>r.value?(V(),H(`div`,Qf,[t[5]||=U(`h3`,{class:`panel-title`},`交易市场`,-1),U(`div`,$f,[t[0]||=U(`span`,{class:`label`},`持有积分:`,-1),U(`span`,ep,O(r.value.currency),1)]),r.value.merchants.length>0?(V(),H(`div`,tp,[t[2]||=U(`h4`,{class:`section-title`},`商人`,-1),U(`div`,np,[(V(!0),H(z,null,I(r.value.merchants,e=>(V(),H(`div`,{key:e.id,class:`merchant-card`},[U(`div`,rp,[U(`span`,ip,O(e.name),1),U(`span`,ap,O(e.location),1)]),e.items.length>0?(V(),H(`div`,op,[t[1]||=U(`h5`,{class:`inventory-title`},`出售物品`,-1),U(`div`,sp,[(V(!0),H(z,null,I(e.items,t=>(V(),H(`div`,{key:t.itemId,class:`item-card`},[U(`div`,cp,[ia(O(t.name)+` `,1),t.qty>1?(V(),H(`span`,lp,`×`+O(t.qty),1)):G(``,!0)]),U(`div`,up,`💰 `+O(t.price),1),U(`button`,{class:`buy-btn`,onClick:n=>i(t.itemId,e.id),disabled:r.value.currency<t.price},` 购买 `,8,dp)]))),128))])])):G(``,!0)]))),128))])])):G(``,!0),r.value.inventory.length>0?(V(),H(`div`,fp,[t[3]||=U(`h4`,{class:`section-title`},`出售背包物品`,-1),U(`div`,pp,[(V(!0),H(z,null,I(r.value.inventory,e=>(V(),H(`div`,{key:e.itemId,class:`price-item`},[U(`span`,mp,O(e.name)+` ×`+O(e.count),1),U(`span`,hp,[U(`span`,gp,O(e.price)+` 积分`,1),U(`button`,{class:`buy-btn`,onClick:t=>a(e.itemId)},`出售`,8,_p)])]))),128))])])):G(``,!0),Object.keys(r.value.prices).length>0?(V(),H(`div`,vp,[t[4]||=U(`h4`,{class:`section-title`},`市场参考价`,-1),U(`div`,yp,[(V(!0),H(z,null,I(r.value.prices,(e,t)=>(V(),H(`div`,{key:t,class:`price-item`},[U(`span`,bp,O(P(Y)[t]?.name||t),1),U(`span`,xp,O(e.currentPrice)+` 积分`,1)]))),128))])])):G(``,!0),r.value.merchants.length===0?(V(),H(`div`,Sp,` 当前没有商人，探索时可能会遇到行商。 `)):G(``,!0)])):G(``,!0)}}),[[`__scopeId`,`data-v-4c20c8ba`]]),wp={key:0,class:`progression-indicator`},Tp={class:`tier-countdown`},Ep={class:`countdown-header`},Dp={class:`label`},Op={class:`days`},kp={class:`countdown-bar`},Ap={key:0,class:`catastrophe-warning`},jp={class:`warning-content`},Mp={class:`warning-desc`},Np={key:1,class:`depletion-warnings`},Pp={class:`depletion-list`},Fp={class:`area-name`},Ip={class:`exploration-count`},Lp={key:2,class:`story-triggers`},Rp={class:`trigger-list`},zp={class:`trigger-name`},Bp=[`onClick`],Vp={class:`story-triggers`},Hp={class:`trigger-section-title`},Up={class:`trigger-list`},Wp={class:`trigger-name`},Gp={class:`ach-desc`},Kp=Tu(or({__name:`ProgressionIndicator`,setup(e){let t=Ql(),n={mysterious_signal:`神秘信号`,alliance_invitation:`联盟邀请`,crystal_discovery:`结晶发现`,survivor_encounter:`幸存者遭遇`,ancient_ruins_hint:`远古遗迹线索`},r=q(()=>{let e=t.state;if(!e||!e.progression)return null;let r=Cs.find(t=>t.triggerDay>(e.day??1))??null,i=e.progression.upcomingCatastrophes??[],a=i.length>0?i[i.length-1]:null;return{worldTier:e.progression.currentWorldTier,worldTierName:Cs[e.progression.currentWorldTier-1]?.name??``,nextTierDay:r?.triggerDay??null,nextTierName:r?.name??``,catastrophe:a,resourceDepletion:e.progression.resourceDepletion??{},storyTriggers:(e.progression.triggeredStories??[]).filter(t=>!e.flags[`story_${t}_started`]).map(e=>({id:e,name:n[e]??e}))}});function i(){let e=r.value;return!e||!e.nextTierDay?0:Math.max(0,e.nextTierDay-(t.state?.day||1))}function a(){let e=r.value;return!e||!e.catastrophe?0:Math.max(0,(e.catastrophe.triggerDay??0)-(t.state?.day||1))}function o(e){return e?{beast_wave:`兽潮来袭`,extreme_weather:`极寒降临`,fog_expansion:`迷雾扩张`,acid_rain:`酸雨降临`,earthquake:`大地震颤`,plague:`瘟疫蔓延`,meteor_shower:`流星雨`}[e]||e:``}let s=q(()=>{let e=t.state;if(!e)return[];let n=new Set(e.meta?.unlockedAchievements??[]);return lc.map(e=>({...e,unlocked:n.has(e.id)}))}),c=q(()=>s.value.filter(e=>e.unlocked).length);return(e,n)=>r.value?(V(),H(`div`,wp,[n[4]||=U(`h3`,{class:`panel-title`},`世界状态`,-1),U(`div`,Tp,[U(`div`,Ep,[U(`span`,Dp,`当前: `+O(r.value.worldTierName),1),U(`span`,Op,O(i()>0?`距「${r.value.nextTierName}」还有 ${i()} 天`:`已至最终等级`),1)]),U(`div`,kp,[U(`div`,{class:`countdown-fill`,style:pe({width:Math.min(100,(P(t).state?.day||1)/(r.value.nextTierDay||1)*100)+`%`})},null,4)])]),r.value.catastrophe?(V(),H(`div`,Ap,[n[1]||=U(`div`,{class:`warning-icon`},`⚠️`,-1),U(`div`,jp,[n[0]||=U(`div`,{class:`warning-title`},`灾难预警`,-1),U(`div`,Mp,O(o(r.value.catastrophe.type))+` 将在 `+O(a())+` 天后降临 `,1)])])):G(``,!0),Object.keys(r.value.resourceDepletion).length>0?(V(),H(`div`,Np,[n[2]||=U(`h4`,{class:`warning-section-title`},`资源枯竭区域`,-1),U(`div`,Pp,[(V(!0),H(z,null,I(r.value.resourceDepletion,(e,t)=>(V(),H(`div`,{key:t,class:`depletion-item`},[U(`span`,Fp,O(t),1),U(`span`,Ip,O(e?`已枯竭`:`开发中`),1)]))),128))])])):G(``,!0),r.value.storyTriggers.length>0?(V(),H(`div`,Lp,[n[3]||=U(`h4`,{class:`trigger-section-title`},`可探索剧情`,-1),U(`div`,Rp,[(V(!0),H(z,null,I(r.value.storyTriggers,e=>(V(),H(`div`,{key:e.id,class:`trigger-item`},[U(`span`,zp,O(e.name),1),U(`button`,{class:`trigger-btn`,onClick:n=>P(t).startStory?.(e.id)},` 开始 `,8,Bp)]))),128))])])):G(``,!0),U(`div`,Vp,[U(`h4`,Hp,`成就（`+O(c.value)+` / `+O(s.value.length)+`）`,1),U(`div`,Up,[(V(!0),H(z,null,I(s.value,e=>(V(),H(`div`,{key:e.id,class:D([`trigger-item ach-item`,{locked:!e.unlocked}])},[U(`span`,Wp,O(e.unlocked?`🏆`:`🔒`)+` `+O(e.name),1),U(`span`,Gp,O(e.desc),1)],2))),128))])])])):G(``,!0)}}),[[`__scopeId`,`data-v-95f400ae`]]),qp={class:`inv-panel`},Jp={key:0,class:`empty`},Yp={key:1,class:`item-list`},Xp={class:`item-head`},Zp={class:`item-name`},Qp={class:`item-count`},$p={class:`lv-row`},em={class:`xp-track`},tm={class:`xp-text`},nm={class:`item-desc`},rm=Tu(or({__name:`InventoryPanel`,setup(e){let t=Ql(),n=q(()=>{let e=t.state;return e?Object.entries(e.inventory??{}).filter(([,e])=>(e??0)>0).map(([t,n])=>{let r=e.itemLevels?.[t],i=r?.level??1,a=r?.uses??0;return{id:t,name:Y[t]?.name??t,desc:Y[t]?.description??``,count:n,level:i,uses:a,need:i*10,pct:Math.min(100,Math.round(a/(i*10)*100))}}).sort((e,t)=>t.count-e.count):[]});return(e,t)=>(V(),H(`div`,qp,[t[0]||=U(`h3`,{class:`panel-title`},`背包`,-1),n.value.length===0?(V(),H(`div`,Jp,` 背包空空如也。外出搜寻，或去市场淘点物资吧。 `)):(V(),H(`div`,Yp,[(V(!0),H(z,null,I(n.value,e=>(V(),H(`div`,{key:e.id,class:`item-card`},[U(`div`,Xp,[U(`span`,Zp,O(e.name),1),U(`span`,Qp,`×`+O(e.count),1)]),U(`div`,$p,[U(`span`,{class:D([`lv-badge`,{maxed:e.level>=5}])},`Lv.`+O(e.level),3),U(`div`,em,[U(`div`,{class:`xp-fill`,style:pe({width:e.pct+`%`})},null,4)]),U(`span`,tm,O(e.uses)+`/`+O(e.need),1)]),U(`p`,nm,O(e.desc),1)]))),128))])),t[1]||=U(`p`,{class:`tip`},`物品每次使用都会累积熟练度；满级后交易价值更高。`,-1)]))}}),[[`__scopeId`,`data-v-e90051e5`]]),im={class:`npc-panel`},am={class:`panel-note`},om={class:`npc-list`},sm={class:`npc-head`},cm={class:`npc-name`},lm={class:`npc-title`},um={class:`favor-row`},dm={class:`favor-track`},fm={class:`favor-num`},pm={class:`npc-desc`},mm={class:`npc-foot`},hm={key:0,class:`joined-badge`},gm=[`onClick`],_m={key:2,class:`hint-badge`},vm={key:3,class:`done-badge`},ym=Tu(or({__name:`NpcPanel`,setup(e){let t=Ql(),n=q(()=>{let e=t.state;return e?Vl(e).map(t=>{let n=_s.find(e=>e.id===t.id);return{...t,recruited:vs(e,t.id),defense:n?.defense??0,rankBonus:n?.rankBonus??0}}):[]}),r=q(()=>{let e=t.state;return e?{count:Vl(e).filter(t=>vs(e,t.id)).length,defense:ys(e),rank:bs(e)}:{count:0,defense:0,rank:0}});function i(e,t){return!t&&e>=30}function a(e){t.recruit?.(e)}return(e,t)=>(V(),H(`div`,im,[t[0]||=U(`h3`,{class:`panel-title`},`同伴羁绊`,-1),U(`p`,am,`在支线中与他们同行，羁绊会随共同经历加深。羁绊达到「信赖」即可邀请入队——同伴提供每日帮助，并在兽潮时协防（当前队伍：`+O(r.value.count)+` 人 · 协防 `+O(r.value.defense)+` · 声望 +`+O(r.value.rank)+`）。`,1),U(`div`,om,[(V(!0),H(z,null,I(n.value,e=>(V(),H(`div`,{key:e.id,class:D([`npc-card`,{done:e.lineDone}])},[U(`div`,sm,[U(`span`,cm,O(e.name),1),U(`span`,lm,O(e.title),1),U(`span`,{class:D([`npc-level`,{max:e.favor>=80}])},O(e.levelName),3)]),U(`div`,um,[U(`div`,dm,[U(`div`,{class:`favor-fill`,style:pe({width:e.favor+`%`})},null,4)]),U(`span`,fm,O(e.favor),1)]),U(`p`,pm,O(e.description),1),U(`div`,mm,[e.recruited?(V(),H(`span`,hm,`✓ 已入队（协防 `+O(e.defense)+` · 声望 +`+O(e.rankBonus)+`）`,1)):i(e.favor,e.recruited)?(V(),H(`button`,{key:1,class:`recruit-btn`,onClick:t=>a(e.id)},`邀请加入（协防 `+O(e.defense)+`）`,9,gm)):(V(),H(`span`,_m,`好感达 30 可邀请`)),e.lineDone?(V(),H(`span`,vm,`✓ 支线已完结`)):G(``,!0)])],2))),128))])]))}}),[[`__scopeId`,`data-v-206e6e7d`]]),bm={class:`layout`},xm={class:`panel left`},Sm={class:`sys`},Cm={class:`panel main`},wm={class:`tab-nav`},Tm=[`onClick`],Em={class:`content-area`},Dm={key:6,class:`empty-view`},Om={class:`footer`},km=Tu(or({__name:`GameScreen`,setup(e){let t=Ql(),n=Jt(`story`),r=q(()=>t.state?.combat!==void 0);zn(r,e=>{e&&(n.value=`combat`)});function i(){let e=t.exportSave();if(!e)return;let n=new Blob([e],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`迷雾降临_存档${t.activeSlot+1}.qssave`,i.click(),URL.revokeObjectURL(r)}let a={story:`📖 剧情`,base:`🏠 基地`,inventory:`🎒 背包`,npc:`👥 同伴`,skills:`⚡ 技能`,combat:`⚔️ 战斗`,market:`💰 市场`,progression:`🌍 推进`};return(e,o)=>(V(),H(`div`,bm,[U(`aside`,xm,[W(td),U(`div`,Sm,[U(`button`,{class:`btn ghost`,onClick:i},`导出存档`),U(`button`,{class:`btn ghost`,onClick:o[0]||=(...e)=>P(t).backToMenu&&P(t).backToMenu(...e)},`主菜单`)])]),U(`main`,Cm,[U(`div`,wm,[(V(),H(z,null,I(a,(e,t)=>U(`button`,{key:t,class:D([`tab-btn`,{active:n.value===t}]),onClick:e=>n.value=t},O(e),11,Tm)),64))]),U(`div`,Em,[n.value===`story`?(V(),Xi(md,{key:0})):n.value===`base`?(V(),Xi(Zd,{key:1})):n.value===`inventory`?(V(),Xi(rm,{key:2})):n.value===`npc`?(V(),Xi(ym,{key:3})):n.value===`skills`?(V(),Xi(Ff,{key:4})):n.value===`combat`&&r.value?(V(),Xi(Zf,{key:5})):n.value===`combat`&&!r.value?(V(),H(`div`,Dm,[...o[3]||=[U(`p`,null,`当前没有战斗，探索时可能会遭遇怪物。`,-1)]])):n.value===`market`?(V(),Xi(Cp,{key:7})):n.value===`progression`?(V(),Xi(Kp,{key:8})):G(``,!0)]),U(`div`,Om,[P(t).state?.outcome?(V(),H(`button`,{key:1,class:`btn ghost wide`,onClick:o[2]||=(...e)=>P(t).backToMenu&&P(t).backToMenu(...e)},`返回主菜单`)):(V(),H(`button`,{key:0,class:`btn primary wide`,onClick:o[1]||=(...e)=>P(t).endDay&&P(t).endDay(...e)},` 结束今日，进入下一天 `))])]),o[4]||=U(`aside`,{class:`panel right`},[U(`h3`,{class:`aside-title`},`生存日志`),U(`p`,{class:`aside-note`},`跟随迷雾中的线索，撑过每一天。`)],-1)]))}}),[[`__scopeId`,`data-v-4c6abbb5`]]),Am={class:`app`},jm={key:0,class:`toast`};Vo(or({__name:`App`,setup(e){let t=Ql();return(e,n)=>(V(),H(`div`,Am,[P(t).screen===`menu`?(V(),Xi(Eu,{key:0})):(V(),Xi(km,{key:1})),W(Ua,{name:`toast`},{default:Nn(()=>[P(t).toast?(V(),H(`div`,jm,O(P(t).toast),1)):G(``,!0)]),_:1})]))}})).mount(`#app`);